...
export const metadata: Metadata = {
  title: "Privacy Policy - S.D Modern School",
  description: "Privacy policy for the official website of S.D Modern School.",
};
    ...
    <div className="pb-24 lg:pb-0">
      ...
      <section className="relative h-[32vh] min-h-[200px] sm:min-h-[240px] md:h-[40vh] md:min-h-[280px] overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url(https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1920&h=1080&fit=crop&auto=format)" }}
        />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-gray-700">
            ...
            <p className="mb-6 text-base sm:text-lg leading-relaxed">
              S.D Modern School (&quot;we&quot;, &quot;our&quot;, or &quot;the Institution&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our official website or use our services.
            </p>
