...
export const metadata: Metadata = {
  title: "Terms and Conditions - S.D Modern School",
  description: "Terms and conditions for using the official website of S.D Modern School.",
};
    ...
    <div className="pb-24 lg:pb-0">
      ...
      <section className="relative h-[32vh] min-h-[200px] sm:min-h-[240px] md:h-[40vh] md:min-h-[280px] overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url(https://images.unsplash.com/photo-14565130808-af1632923661?w=1920&h=1080&fit=crop&auto=format)" }}
        />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-gray-700">
            ...
            <p className="mb-6 text-base sm:text-lg leading-relaxed">
              By accessing and using the official website of S.D Modern School, you accept and agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our website.
            </p>
            ...
            <p className="mb-6 text-base sm:text-lg leading-relaxed">
              To the fullest extent permitted by law, S.D Modern School shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of or inability to use this website or any content thereon.
            </p>
