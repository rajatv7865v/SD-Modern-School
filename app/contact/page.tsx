...
export default function Contact() {
  ...
  const contactCards = [
    {
      title: 'Address',
      content: 'Gijhore, Sector 53, Noida, Uttar Pradesh 201307, India',
      icon: (
    ...
    <div>
      ...
      <section className="relative h-[50vh] min-h-[400px] max-h-[600px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1596524430615-b46475ddff6e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
          }}
        >
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Gijhore, Sector 53<br />
                        Noida, Uttar Pradesh 201307<br />
                        India
                      </p>
                    </div>
                    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 bg-primary-600 mx-auto mb-4"></div>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Visit our campus at Gijhore, Sector 53, Noida
              </p>
            </div>
